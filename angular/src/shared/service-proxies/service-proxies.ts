...
@Injectable()
export class MasalarServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    get(): Observable<MasaDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Masalar/Get";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<MasaDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<MasaDto[]>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<MasaDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(MasaDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return _observableOf<MasaDto[]>(null as any);
    }
     ...
     * @return Success
     */
    create(body: MasaDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Masalar/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    masaGuncelle(id: number | undefined, body: MasaDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Masalar/MasaGuncelle?";
        if (id === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processMasaGuncelle(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processMasaGuncelle(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processMasaGuncelle(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Masalar/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
...
@Injectable()
export class PhonelerServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    get(): Observable<PhonelerDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Phoneler/Get";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PhonelerDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PhonelerDto[]>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<PhonelerDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(PhonelerDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return _observableOf<PhonelerDto[]>(null as any);
    }
     ...
     * @return Success
     */
    create(body: PhonelerDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Phoneler/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    phoneGuncelle(id: number | undefined, body: PhonelerDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Phoneler/PhoneGuncelle?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPhoneGuncelle(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPhoneGuncelle(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processPhoneGuncelle(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    satilanlariListele(): Observable<PhonelerDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Phoneler/SatilanlariListele";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSatilanlariListele(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSatilanlariListele(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PhonelerDto[]>;
                }
            } else
    ...
    protected processSatilanlariListele(response: HttpResponseBase): Observable<PhonelerDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    satilmayanlariListele(): Observable<PhonelerDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Phoneler/SatilmayanlariListele";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSatilmayanlariListele(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSatilmayanlariListele(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PhonelerDto[]>;
                }
            } else
    ...
    protected processSatilmayanlariListele(response: HttpResponseBase): Observable<PhonelerDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    stokAdedi(): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/Phoneler/StokAdedi";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processStokAdedi(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processStokAdedi(response_ as any);
                } catch (e) {
    ...
    protected processStokAdedi(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    sat(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Phoneler/Sat?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSat(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSat(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processSat(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    garantileriListele(): Observable<PhonelerDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Phoneler/GarantileriListele";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGarantileriListele(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGarantileriListele(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PhonelerDto[]>;
                }
            } else
    ...
    protected processGarantileriListele(response: HttpResponseBase): Observable<PhonelerDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Phoneler/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
...
export class MasaDto implements IMasaDto {
    id: number;
    malzemesi: string | undefined;
    ayakSayisi: number;
    eni: number;
    boyu: number;
    islevi: string | undefined;
    marka: string | undefined;

    constructor(data?: IMasaDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.malzemesi = _data["malzemesi"];
            this.ayakSayisi = _data["ayakSayisi"];
            this.eni = _data["eni"];
            this.boyu = _data["boyu"];
            this.islevi = _data["islevi"];
            this.marka = _data["marka"];
        }
    }

    static fromJS(data: any): MasaDto {
        data = typeof data === 'object' ? data : {};
        let result = new MasaDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["id"] = this.id;
        data["malzemesi"] = this.malzemesi;
        data["ayakSayisi"] = this.ayakSayisi;
        data["eni"] = this.eni;
        data["boyu"] = this.boyu;
        data["islevi"] = this.islevi;
...
export class PhonelerDto implements IPhonelerDto {
    id: number;
    marka: string | undefined;
    ...
    ekranBouyutu: string | undefined;
    garanti: number;
    satildiMi: boolean;
    stokAdedi: number;

    constructor(data?: IPhonelerDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hafiza = _data["hafiza"];
            this.ram = _data["ram"];
            this.renk = _data["renk"];
            this.ekranBouyutu = _data["ekranBouyutu"];
            this.garanti = _data["garanti"];
            this.satildiMi = _data["satildiMi"];
            this.stokAdedi = _data["stokAdedi"];
        }
    }

    static fromJS(data: any): PhonelerDto {
        data = typeof data === 'object' ? data : {};
        let result = new PhonelerDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["hafiza"] = this.hafiza;
        data["ram"] = this.ram;
        data["renk"] = this.renk;
        data["ekranBouyutu"] = this.ekranBouyutu;
        data["garanti"] = this.garanti;
        data["satildiMi"] = this.satildiMi;
        data["stokAdedi"] = this.stokAdedi;
        return data;
    }
